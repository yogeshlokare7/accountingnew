        ...
        <div class="widget-box" style="width: 80%;border-bottom: solid 1px #CDCDCD;">
            <div class="widget-title">
                <ul class="nav nav-tabs">
                    <li class="active"><a  data-toggle="tab" href="#tab1">CREATE COST CODE</a></li>
                </ul>
            </div>
            <br/>
                ...
                <tr>
                    <td>
                        <fieldset  class="well the-fieldset">
                            <table>
                                <tr>
                                    <td style="width: 10%"><label class="control-label"   class="control-label">COST CODE *&nbsp;:&nbsp</label></td>
                                    <td>
                                        <input  type="text" name=""  id="" placeholder="" value="" />
                                        <div id="error" style="color: red"></div>
                                    </td>
                                    <td style="width: 15%"><label class="control-label">COST CODE NAME*&nbsp;:&nbsp</label></td>
                                    <td><input  type="text" name="" id="" placeholder="" value=""/></td>
                                </tr>
                                <tr>
                                    <td style="width: 10%"><label class="control-label">Budget&nbsp;:&nbsp</label></td>
